...
.body {
  width: 100vw;
  height: 100vh;
  animation: bodysss 60s linear infinite;
  -webkit-animation: bodysss 60s linear infinite;
...
.stars {
  ...
  /* sky.png stars.png */
  background: url('http://qnimg.zowoyoo.com/img/null/1627488620834.png') repeat center top;
  bottom: 0;
  left: 0;
  opacity: 0;
  position: absolute;
...
.hills {
  background-image: url('http://qnimg.zowoyoo.com/img/null/1627488685677.png');
  bottom: 30px;
  height: 640px;
  z-index: 20;
}
.country {
  background-image: url('http://qnimg.zowoyoo.com/img/null/1627488707593.png');
  bottom: 2px;
  height: 600px;
  z-index: 40;
}
.foreground {
  background-image: url('http://qnimg.zowoyoo.com/img/null/1627488734634.png');
  bottom: -10px;
  height: 400px;
  z-index: 50;
}
...
.button-home {
  height: 57px;
  width: 250px;
  background: url('http://qnimg.zowoyoo.com/img/null/1627488754180.png') no-repeat center -57px;
